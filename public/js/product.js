...
const specialProduct = () => __awaiter(void 0, void 0, void 0, function* () {
    const listProData = yield getData('http://localhost:3000/product/special');
...
const newProduct = () => __awaiter(void 0, void 0, void 0, function* () {
    const listProData = yield getData('http://localhost:3000/product/date');
    const listPro = listProData.map((pro) => new Product(pro));
...
newProduct();
const viewsProduct = () => __awaiter(void 0, void 0, void 0, function* () {
...
viewsProduct();
const avaProduct = () => __awaiter(void 0, void 0, void 0, function* () {
    const listProData = yield getData('http://localhost:3000/product/avatar');
    const listPro = listProData.map((pro) => new Product(pro));
...
const detailProduct = () => __awaiter(void 0, void 0, void 0, function* () {
    const proId = window.location.pathname.split('/')[3];
    const listProData = yield getData(`http://localhost:3000/product/${proId}`);
    const listPro = listProData.map((pro) => new Product(pro));
...
detailProduct();
const watchingProduct = () => __awaiter(void 0, void 0, void 0, function* () {
    const proId = window.location.pathname.split('/')[3];
    const listProData = yield getData(`http://localhost:3000/product/${proId}`);
    const listPro = listProData.map((pro) => new Product(pro));
...
watchingProduct();
const catesnewcom = () => __awaiter(void 0, void 0, void 0, function* () {
    const listProData = yield getData('http://localhost:3000/product/special');
    const listPro = listProData.map((pro) => new Product(pro));
